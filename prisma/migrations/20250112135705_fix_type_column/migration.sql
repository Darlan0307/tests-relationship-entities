/*
  ...
  - You are about to alter the column `wasPresent` on the `student_frequencies` table. The data in that column could be lost. The data in that column will be cast from `Boolean` to `Int`.
